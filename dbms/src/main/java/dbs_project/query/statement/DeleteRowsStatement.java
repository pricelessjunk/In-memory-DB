...
/**
 * Delete rows statement. Deletes all rows from the table with the given name that
 * fulfill the predicate.
 */
public interface DeleteRowsStatement extends StatementElementTable, StatementElementPredicate {
